...
const Works = () => {
  return (
    <>
      <motion.dev variants={textVariant()} className="opacity-100">
        <p className={styles.sectionSubText} style={{opacity:100}}>My work</p>
      ...
      <div className="w-full">
        ...
        >
          Here are some projects I've worked on.<br></br>You can find more on my GitHub & LinkedIn.
        </motion.p>
